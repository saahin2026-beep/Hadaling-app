...
const inputWrap = { display: 'flex', alignItems: 'center', gap: 'clamp(6px, 1.2vh, 10px)', padding: '3px', borderRadius: 'clamp(8px, 2vw, 12px)', background: 'rgba(255,255,255,0.08)', borderWidth: '1.5px', borderStyle: 'solid', borderColor: 'rgba(255,255,255,0.12)', marginBottom: 'clamp(8px, 1.8vh, 14px)', transition: 'all 0.2s ease' };
